...
2. **Para cada URL pendiente**:
   ...
   d. **Ejecutar auto-pipeline completo por oferta**: Evaluación A-G → Report .md → Executive DOCX inmediato → PDF (si score >= 3.0) → Tracker
      - El DOCX debe generarse antes de comenzar la siguiente URL, incluso cuando haya agentes en paralelo.
      - Ruta: `data/cv_optimization/reports/{company-slug}-{role-slug}-executive-report.docx`
